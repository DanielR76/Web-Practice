class Persona {
	...
	soyBajo() {
		console.log(
			`mi estatura es ${this.altura}, entonces soy bajo? ${this.altura < 1.8}`
		);
	}
}
...
class Desarrollador extends Persona {
	...
	saludar(respuesta) {
		console.log(
			`Hola, soy ${this.nombre} ${this.apellido} y soy desarrollador`
		);
		if (respuesta) {
...
var Daniel = new Persona("Daniel", "Rodriguez", 1.7);
